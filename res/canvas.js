    ...
    function mountains(){
        ...
        trees(30,canvas.height - 60);
        trees(60,canvas.height - 65);
        trees(90,canvas.height - 63);
        trees(canvas.width - 70,canvas.height - 42);
        trees(canvas.width - 30,canvas.height - 45);
        ...
        ctx.quadraticCurveTo(canvas.width/4,canvas.height/2 + 40,canvas.width/2,canvas.height - 50);
        ctx.quadraticCurveTo(3*canvas.width/4,3*canvas.height/4 + 30,canvas.width,canvas.height - 50);
        ctx.lineTo(canvas.width,canvas.height - 30);
        ctx.closePath();
        ctx.fill();

        ctx.beginPath();
        ctx.fillStyle = "rgba(85,136,240,0.3)";
        ctx.moveTo(0,canvas.height - 30);
        ctx.lineTo(0,canvas.height/2 + 40);
        ctx.lineTo(canvas.width/4 + 10,canvas.height/2 + 10);
        ctx.lineTo(canvas.width/2,canvas.height/2 + 50);
        ctx.lineTo(3*canvas.width/4 + 10,canvas.height/2 + 47);
        ctx.lineTo(3*canvas.width/4 + 50,canvas.height/2 + 20);

        // ctx.lineTo(3*canvas.width/4 + 60,canvas.height/2 + 60);
        ...
        ctx.lineTo(canvas.width/4 - 15,canvas.height/2 - 10);
        ctx.lineTo(canvas.width/4 + 40,canvas.height/2 + 30);
        ctx.lineTo(canvas.width/2 - 10,canvas.height/2 - 13);
        ctx.lineTo(3*canvas.width/4,canvas.height/2 + 40);
        ctx.lineTo(3*canvas.width/4 + 40,canvas.height/2 + 6);
...
var canon = {
  ...
  draw: function(){
    ...
    function init(){
        ...
        collide_canon = false;
        base_score = 0;
        loop = setInterval(newRock,4000);
        time = setInterval(function(){
            bullets.push(new bullet());
        },timeInterval);
    }

    // setInterval(drawBullets,timeInterval);
   ...
   function increaseBulletRate(){
    if(!(curr_score % 5) && timeInterval > 10 && curr_score > base_score){
        timeInterval -= 20;
        clearInterval(time);
        time = setInterval(function(){
            bullets.push(new bullet);
...
flag *= -1;
var y = random(0,canvas.width/2 - 30);
var strength = random(20,100);
...
function startScreen(){
    ...
    ctx.save();
        // ctx.fillStyle = "rgba(0,0,0,0.4)";
        // ctx.fillRect(10,canvas.height/2 - 10,canvas.width - 20,canvas.height - 20);
        ctx.fillStyle = "#000000";
        ctx.font = "20px Consolas";
        ...
        ctx.fillText("3. Press any key to start the game",canvas.width/4 - 60,canvas.height/2 + 65);
        ctx.restore();
    }
